...
#define STRING_CONFIG_H_AUTHOR "(Szymon Signal RACK)" // Who made the changes.
...
#ifdef RAMPS
#define CUSTOM_MACHINE_NAME "Signal RAMPS"
#endif

#ifdef SKR
#define CUSTOM_MACHINE_NAME "Signal SKR"
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1068, 415 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 50), (Y_MIN_POS + 10), 5 }
  #define NOZZLE_PARK_XY_FEEDRATE 100   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE 2.5      // (mm/s) Z axis feedrate (not used for delta printers)
#endif
